...
declare type REALITY_ETH_VERSION = "v1.0.0";
declare type BRIDGE_VERSION = "v1.0.0";
declare type DELAY_VERSION = "v1.0.0";
declare type FACTORY_VERSION = "v1.0.0";
declare type SCOPE_GUARD_VERSION = "v1.0.0";
declare type EXIT_ERC20_VERSION = "v1.0.0" | "v1.1.0";
declare type EXIT_ERC721_VERSION = "v1.1.0";
declare type CIRCULATING_SUPPLY_ERC20_VERSION = "v1.0.0" | "v1.1.0";
declare type CIRCULATING_SUPPLY_ERC721_VERSION = "v1.1.0";
declare type ROLES_MOD_VERSION = "v1.0.0";
declare type ContractMasterCopies<V extends string> = Record<V, string>;
